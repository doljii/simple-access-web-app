...
import { Banknote, Plus, TrendingUp, TrendingDown, Search } from 'lucide-react';
import { toast } from '@/hooks/use-toast';
import { supabase } from '@/integrations/supabase/client';
import { useAuth } from '@/hooks/useAuth';

interface KasBesarType {
  id: string;
  tanggal: string;
  keterangan: string;
  tipe: 'masuk' | 'keluar';
...
const KasBesar = () => {
  const [transactions, setTransactions] = useState<KasBesarType[]>([]);
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      if (error) {
        ...
        toast({
          title: "Error",
          description: "Failed to load kas besar data",
          variant: "destructive"
        });
      } else {
